...
Live products filtering for Easy Digital Downloads.
...
If you want to boost EDD Ajax Filters, you can also visit our page and explore the [official page](http://tsunoa.com/downloads/edd-ajax-filters/) of the premium version, which includes all the following features to improve at the best your Easy Digital Downloads store search.
...
For a more detailed list of options and features of EDD Ajax Filters, please read the [official documentation](http://tsunoa.com/docs/edd-ajax-filters/ "EDD Ajax Filters Official Documentation").

= Compatibility with other plugins =

EDD Ajax Filters has been tested with the following plugins:

* [**EDD Ajax Search**](https://wordpress.org/plugins/edd-ajax-search/)
...
1. EDD Ajax Filters
2. EDD Ajax Filters content sample
3. Admin - Tsunoa -> EDD Ajax Filters
...
Also you can check the [official shortcode documentation](http://tsunoa.com/docs/edd-ajax-filters/free-version/shortcodes "EDD Ajax Filters Official Documentation") to meet in deep this powerful shortcode.

== Suggestions ==

If you have suggestions about how to improve EDD Ajax Filters, you can [write us](mailto:contact@tsunoa.com "Tsunoa") so we can bundle them into EDD Ajax Filters.
...
[use](https://tsunoa.com/contact/ "Tsunoa") so we can bundle it into EDD Ajax Filters languages.
